...
export function Avatar(props) {
    ...
    <skinnedMesh
		...
		material={new THREE.MeshStandardMaterial({ color: new THREE.Color(0x000000) })} 
    ...
    <skinnedMesh
        ...
        material={new THREE.MeshStandardMaterial({ color: new THREE.Color(0x000000) })}  // Change hair color here
